    ...
    while True: # keep running script until sending time
        if msgDate == today:
            ...
            if current_time >= msgTime:
                ...
                chrome_browser = webdriver.Chrome(executable_path=r'/home/collins/Downloads/Compressed/chromedriver_linux64/chromedriver', options=options)
                print("done")
                chrome_browser.execute_script("window.onbeforeunload = function() {};") 
                chrome_browser.get('https://web.whatsapp.com/')
                time.sleep(10)
                 
                user_name_list = ['Mwesigwa Joshua', '+256787689679']
